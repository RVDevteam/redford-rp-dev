Translation = {
    ...
    Ukrainian = {
        Notify = {
            testText = "Це тестове сповiщення",
            userNonExistent = "ID неправильний або користувач не iснує.",
            ReadSuggestion = "Будь ласка, прочитайте пiдказки в чатi щодо використання команди.",
            SetGroup = "Ви присвоїли групу ID: %d",
            SetGroup1 = "Адмiнiстратор присвоїв вам групу %s",
            AddJob = "Ви присвоїли роботу %s ID %d Рiвень %d",
            AddJob1 = "Персонал присвоїв вам роботу %s Рiвень %d",
            error = "введiть 0 для готiвки та 1 для золота",
            AddMoney = "Ви присвоїли валюту %d ID %d",
            AddMoney1 = "Отримано вiд адмiнiстратора суму %d",
            invfull = "iнвентар повний",
            cantcarry = "не можна нести бiльше цього предмета",
            removedcurrency = "Ви видалили %d $ з ID: %d",
            revived = "гравець iз серверним ID %d був вiдроджений",
            radius = "радiус має бути бiльшим за 1",
            namechange = "Ваше iм'я було змiнено на: %s %s адмiнiстратором",
            banned = "був забанений назавжди",
            banned2 = "забанив когось до ",
            banned3 = "Ви були забаненi назавжди!",
            healself = "Ви вiдродили себе.",
            healall = "Ви були зцiленi.",
            healedPlayer = "гравець iз серверним ID %d був зцiлений",
            AddItems = "Предмет %s з кiлькiстю %d додано до вашого iнвентарю",
            AddWeapons = "Зброю додано до вашого iнвентарю",
            Exp = "досвiд надано гравцевi ",
            GivenExp = "ви отримали %s досвiду в %s",
            NotFound = "навичка не знайдена",
            Level = "Ви %s рiвня %s з %s досвiду в %s",
            left = {
                title = "~e~ВАЖЛИВО!",
                subtitle = "ви повиннi встановити висоту персонажа на 1.0, iнакше будуть помилки.",
                dict = "minigames_hud",
                icon = "five_finger_burnout",
                color = "COLOR_RED",
            },
            left1 = {
                title = "~e~ВАЖЛИВО!",
                subtitle = "Пiсля видалення персонажа повернення назад неможливе!",
                dict = "minigames_hud",
                icon = "five_finger_burnout",
                color = "COLOR_RED",
            },
        ...
        Commands = {
            webHookMessage = "**Iм'я в Steam: **`%s`**\nIдентифiкатор**`%s` \n**Discord:** <@%s>**\nIP: **`%s`",
            addGroup = {
                custom = "\n**ID гравця** `%d`\n**Присвоєна група** `%s`",
                tittle = "📋 `/addGroup команда`",
                label = "Команда VORPcore для призначення групи користувачу",
                help = 'ID гравця',
                help1 = 'Назва групи',
                name = "Id",
                name1 = "Група"
            ...
            addGroupCharacter = {
                custom = "\n**ID гравця** `%d`\n**Присвоєна група** `%s`",
                tittle = "📋 `/addGroupChar команда`",
                label = "Команда VORPcore для призначення групи персонажу",
                help = 'ID гравця',
                help1 = 'Назва групи',
                name = "Id",
                name1 = "Група"
            ...
            addJob = {
                custom = "\n**ID гравця:** `%d` \n**Присвоєна робота** `%s`\n**Рiвень:** `%d`",
                tittle = "📋 `/Job команда`",
                label = "Команда VORPcore для призначення роботи та рiвня гравцевi",
                help = 'ID гравця',
                help1 = 'Назва роботи',
                help2 = 'Назва роботи',
                help3 = 'Мiтка роботи',
            ...
            addItem = {
                custom = "\n**ID гравця:** `%d` \n**Присвоєний предмет** `%s`\n**Кiлькiсть:** `%d`",
                title = "📋 `/additems команда`",
                label = "Команда VORPcore для надання предметiв",
                help = 'ID гравця',
                help1 = 'Назва предмета',
                help2 = 'Кiлькiсть',
                name = "Id",
                name1 = "НазваПредмета",
                name2 = "Кiлькiсть",
            ...
            addWeapon = {
                custom = "\n**ID гравця** `%d` \n**Присвоєна зброя** `%s`",
                title = "📋 `/addweapon команда`",
                label = "Команда VORPcore для надання зброї",
                help = 'ID гравця',
                help1 = 'Хеш-назва зброї',
                name = "Id",
                name1 = "ХешНазва",
            },
            delMoney = {
                custom = "\n**ID гравця** `%d` \n**Тип** `%d`\n**Кiлькiсть** `%d`",
                title = "📋 `/delmoney команда`",
                label = "Команда VORPcore для видалення грошей",
                help = 'ID гравця',
                help1 = 'Введiть 0 для готiвки та 1 для золота',
                help2 = 'Кiлькiсть',
                name = "Id",
                name1 = "Тип",
                name2 = "Кiлькiсть",
            ...
            addMoney = {
                custom = "\n**ID гравця** `%d` \n**Тип** `%d`\n**Кiлькiсть** `%d`",
                title = "📋 `/addmoney команда`",
                label = "Команда VORPcore для надання грошей",
                help = 'ID гравця',
                help1 = 'Введiть 0 для готiвки, 1 для золота та 2 для рол',
                help2 = 'Кiлькiсть',
                name = "Id",
                name1 = "Тип",
                name2 = "Кiлькiсть",
            ...
            delWagons = {
                custom = "`\n**ID гравця** `%d`\n **Дiя:** `Використано delwagons` \n **Радiус:** `%d`",
                title = "📋 `/delwagons команда`",
                label = "Команда VORPcore для видалення возiв у радiусi",
                help = 'введiть число вiд 1 до будь-якого',
                name = "Радiус",
            },
            revive = {
                custom = "`\n**ID гравця** `%d`\n **Дiя:** `Був вiдроджений`",
                title = "📋 `/revive команда`",
                label = "Команда VORPcore для вiдродження гравця",
                help = 'ID гравця',
                name = "Id",
            },
            teleport = {
                custom = "`\n**ID гравця** `%d`\n **Дiя:** `Був телепортований`",
                title = "📋 `/teleport команда`",
                label = "Команда VORPcore для телепортацiї",
                help = 'ID гравця',
                name = "Id",
            },
            delHorse = {
                custom = "`\n**ID гравця** `%d `\n **Дiя:** `Використано Delhorse`",
                title = "📋 `/delhorse команда`",
                label = "Команда VORPcore для видалення коней",
            },
            heal = {
                custom = "`\n**ID гравця** `%d `\n **Дiя:** `Використано Heal`",
                title = "📋 `/heal команда`",
                label = "Команда VORPcore для зцiлення гравця",
                name = "Id",
                help = 'ID гравця',
            },
            addWhitelist = {
                custom = "`\n**ID гравця** `%d `\n **Дiя:** `Використано Whitelist`",
                title = "📋 `/whitelist команда`",
                label = "Команда VORPcore для додавання гравця до бiлого списку",
                name = "Steamid",
                help = "приклад ID Steam: 11000010c8aa16e",
            },
            unWhitelist = {
                custom = "`\n**ID гравця** `%d `\n **Дiя:** `Використано Unwhitelist`",
                title = "📋 `/unwhitelist команда`",
                label = "Команда VORPcore для видалення гравця з бiлого списку",
                name = "Steamid",
                help = "приклад ID Steam: 11000010c8aa16e",
            },
            ban = {
                custom = "\n**ID гравця:** `%d`\n **Дiя:** `Використано ban`",
                title = "📋 `/ban команда`",
                label = "Команда VORPcore для бану гравця",
                name = "Steamid",
                name1 = "Час",
                help = "приклад ID Steam: 11000010c8aa16e",
                help1 = "Час бану: d для дня, w для тижня, m для мiсяця, y для рокiв. Наприклад: /ban steamid d2 - гравець буде забанений на 2 днi",
            },
            unBan = {
                custom = "\n**ID гравця:** `%d`\n **Дiя:** `%s`",
                title = "📋 `/unban команда`",
                label = "Команда VORPcore для розбану гравця",
                name = "Steamid",
                help = "приклад ID Steam: 11000010c8aa16e",
            },
            warn = {
                custom = "\n**ID гравця:** `%d`\n **Дiя:** `Використано warn`",
                title = "📋 `/warn команда`",
                label = "Команда VORPcore для попередження гравця",
                name = "Steamid",
                help = "приклад ID Steam: 11000010c8aa16e",
            },
            unWarn = {
                custom = "\n**ID гравця:** `%d`\n **Дiя:** `Використано unwarn`",
                title = "📋 `/unwarn команда`",
                label = "Команда VORPcore для зняття попередження з гравця",
                name = "Steamid",
                help = "приклад ID Steam: 11000010c8aa16e",
            },
            charName = {
                custom = "\n**ID гравця:** `%d`\n **Дiя:** `Використано charname` \n **Iм'я: ** `%s %s`",
                title = "📋 `/charname команда`",
                label = "Команда VORPcore для змiни iменi гравця",
                name = "Id",
                name1 = "Iм'я",
                name2 = "Прiзвище",
                help = "ID гравця",
                help1 = "приклад iменi: Iван",
                help2 = "приклад прiзвища: Шевченко",
            },
            charCreateAdd = {
                custom = "\n**ID гравця:** `%d`\n **Дiя:** `Використано charcreateadd`",
                title = "📋 `/addchar команда`",
                label = "Команда VORPcore для дозволу створення бiльше одного персонажа. За замовчуванням: " .. Config.MaxCharacters,
                name = "ID гравця",
                name1 = "Кiлькiсть",
                help = "ID гравця, гравець має бути в грi",
                help1 = "кiлькiсть персонажiв для оновлення, не iнкрементна",
            },
            myJob = {
                title = "📋 `/myjob команда`",
                label = "Команда VORPcore для перевiрки вашої роботи",
            },
            giveExp = {
                custom = "\n**ID гравця:** `%d`\n**Навичка:** `%s`\n**Додано досвiду:** `%d`",
                title = "📋 `/addExp команда`",
                label = "Команда VORPcore для додавання досвiду гравцевi",
                help = "ID гравця",
                help1 = "категорiя навички, наприклад, Ремесло",
                help2 = "кiлькiсть досвiду для надання",
                name = "Id",
                name1 = "Навичка",
                name2 = "Досвiд",
            },
            myExp = {
                custom = "\n**ID гравця:** `%d`\n**Перевiрена навичка:** `%s`",
                title = "📋 `/myExp команда`",
                label = "Команда VORPcore для перевiрки вашого досвiду навички",
                help = "категорiя навички, наприклад, Ремесло",
                name = "Навичка",
            },
        },
        addWebhook = {
            whitelistid = "**Iм'я Steam: **`%s`**\nIдентифiкатор:** `%s`\n**Discord:** <@%s>\n**ID користувача:** `%s`",
            whitelistid1 = "📋` Новий гравець приєднався до сервера`",
            DeathLogTitle = "Журнал смертей гравця",
            PlayerDied = "Гравець помер",
            victimSteamName = "Iм'я Steam жертви: ",
            victimSteamId = "Steam ID жертви: ",
            victimServerId = "ID сервера жертви: ",
            killerSteamName = "Iм'я Steam вбивцi: ",
            killerSteamId = "Steam ID вбивцi: ",
            killerServerId = "ID сервера вбивцi: "
        },
        MessageOfSystem = {
            IsConnected = "❌ Доступ заборонено: виявлено дубльований акаунт (Steam | Rockstar)",
            TwoAccounts = "❌ Доступ заборонено: спроба входу з iншого акаунта.",
            TwoAccounts2 = "❌ Доступ заборонено: ID Steam вже зареєстрований на серверi.",
            AccountEarlyLoad = "❌ Доступ заборонено: триває завантаження акаунта.",
            AccountEarlyLoad2 = "❌ Доступ заборонено: подвiйне завантаження акаунта не дозволено.",
            NoSteam = "❌ Потрiбен Steam: будь ласка, вiдкрийте Steam i перезапустiть RedM.",
            NoDiscord = "❌ Потрiбен Discord: будь ласка, вiдкрийте Discord i перезапустiть RedM.",
            NoInWhitelist = "❌ Доступ заборонено: користувач не в бiлому списку. Будь ласка, надiшлiть свiй Steam ID у наш Discord: ",
            NoPermissions = "У вас недостатньо прав",
            CheckingIdentifier = "Перевiрка iдентифiкаторiв",
            LoadingUser = "Завантаження користувача",
            BannedUser = "Ви забаненi до ",
            DropReasonBanned = "Ви були забаненi з сервера до ",
            Warned = "Ви отримали попередження",
            Unwarned = "Попередження знято",
            TitleOnDead = "Введiть /calldoctor у чатi, щоб викликати лiкаря", -- вам потрiбен скрипт для цього, це лише приклад
            SubTitleOnDead = "Ви можете вiдродитися через %s секунд",
            SecondsMove = " секунд",
            YouAreCarried = "Вас несе iнша людина",
            promptLabel = "Вiдродитися",
            prompt = "Вiдродитися",
            wayPoint = "~e~Спочатку потрiбно встановити точку маршруту!",
            mustBeSeated = "~e~Ви повиннi сидiти на мiсцi водiя!",
            wagonInFront = "~e~Ви повиннi сидiти або бути поруч iз возом, щоб видалити його!",
            cantCarry = "~e~Не можна нести бiльше зброї!",
            Hold = "RedFord UA",
            Load = "Радi знову Вас вiтати!",
            Almost = "Ви майже прокинулися...",
            Holddead = "ВИ МЕРТВI",
            Loaddead = "ви покинули сервер, будучи мертвим",
            forcedrespawn = "ВИ БУДЕТЕ ВIДРОДЖЕНI",
            forced = "Тому що ви покинули сервер, будучи мертвим",
            sit = "вам потрiбно сидiти",
            PVPNotifyOn = "PVP увiмкнено",
            PVPNotifyOff = "PVP вимкнено",
            StopAnimCooldown = "Не спамте",
            AddChar = "Додано мультик персонажа",
            RemoveChar = "Видалено мультик персонажа",
            WrongHex = "Hex не знайдено в базi даних або неправильний Hex",
            myjob = "ваша робота: ~o~",
            mygrade = " ~q~рiвень: ~o~",
            charhours = "години вашого персонажа: ~o~ %d",
            playhours = "годин зiграно: ~o~ %d",
            RespawnIn = "Ви можете вiдродитися через ",
            message = " або " .. " /calldoctor",
            message2 = "Час вiдродження минув",
            message3 = "Вам потрiбно зачекати, поки ви зможете вiдродитися",
            message4 = "ID гравця ",
            message5 = "ви були пораненi, за правилами ви повиннi забути останнi 30 хвилин",
            message6 = "Вiдродження!!!",
            permanentlyBan = "Ви забаненi назавжди!",
            PlayerWhenFocus = "Гравець",
            CantBanSelf = "Ви не можете забанити себе",
            Wepnotexist = "зброя не iснує або назва неправильна",
            PlayerJoinLeave = {
                Leave = "Гравець **%s** (Steam: `%s`) покинув сервер. %s",
                Reason = "Причина: ",
                Leavetitle = "Вихiд гравця",
                Join = "Гравець **%s** (Steam: `%s`) пiдключається до сервера.",
                Jointitle = "Приєднання гравця",
            },
        },
        SuggestChat = {
            hideUi = "Команда VORPcore для ПРИХОВУВАННЯ всiх iнтерфейсiв з екрану, зручно для скрiншотiв.",
            toogleUi = "Команда VORPcore для перемикання iнтерфейсiв VORP на екранi",
            stopAnim = "Команда VORPcore для використання, якщо ви застрягли в анiмацiї.",
            tooglePVP = "Команда VORPcore для УВIМКНЕННЯ/ВИМКНЕННЯ PvP для вашого персонажа.",
        },
    }
}
